...
- path: /etc/systemd/system/container-sshd.service
  ...
  content: |
    ...
    ExecStart=/usr/bin/docker run --rm --name=container-sshd -p{config.CONTAINER_SSHD_PORT}:22 -v /mnt/disks/{instance_config.pd_name}/home/ubuntu:/home/ubuntu {instance_config.docker_image} /usr/sbin/sshd -D -e
